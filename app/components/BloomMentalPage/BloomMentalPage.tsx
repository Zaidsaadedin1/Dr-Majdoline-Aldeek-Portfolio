            ...
            {services.map((service, index) => (
              <Grid.Col key={index} span={{ base: 12, md: 6, lg: 4 }}>
                ...
                >
                  ...
                  <Text c="dimmed" size="sm" ta={isRTL ? "right" : "left"}>
                    {service.description}
                  </Text>
                </Card>
              </Grid.Col>
            ...
            {features.map((feature, index) => (
              <Grid.Col key={index} span={{ base: 12, md: 6 }}>
                <Group align="flex-start" gap="md">
                  ...
                  <Box flex={1}>
                    <Title order={4} mb="xs" ta={isRTL ? "right" : "left"}>
                      {feature.title}
                    </Title>
                    <Text c="dimmed" size="sm" ta={isRTL ? "right" : "left"}>
                      {feature.description}
            ...
            {testimonials.map((testimonial, index) => (
              <Grid.Col key={index} span={{ base: 12, md: 4 }}>
                <Card shadow="sm" radius="lg" p="lg" h="100%">
                  ...
                  <Text fw={500} c="pink" ta={isRTL ? "right" : "left"}>
                    - {testimonial.name}
                  </Text>
                </Card>
              </Grid.Col>
        ...
        <Paper p="xl" radius="lg" bg="pink.0">
          <Grid>
            <Grid.Col span={{ base: 12, md: 6 }}>
              <Title order={2} mb="md" c="pink" ta={isRTL ? "right" : "left"}>
                {t("contact_title")}
              </Title>
              <Text mb="xl" c="dimmed" ta={isRTL ? "right" : "left"}>
                {t("contact_subtitle")}
              </Text>
